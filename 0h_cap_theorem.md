...
These are in contrast to the ACID theorem, which generally explains how SQL databases behave. We discussed the [ACID theorem](https://new.learnhowtoprogram.com/ruby-and-rails/ruby-database-basics/acid-databases) in Ruby/Rails and C#/.NET, but if you need a refresher or didn't go through those courses, we recommend taking a look.
