...
This is the biggest challenge for students coming from using SQL. They often want to know how to establish relationships between different records in a database. We will cover some basic ways to do this in the lesson [Structuring Data in Firestore](/react/react-with-nosql-part-2/structuring-data-in-firestore), but this simply isn't a strength of NoSQL.
